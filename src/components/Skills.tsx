...
import {
  FaReact, FaPython, FaNodeJs, FaGitAlt, FaHtml5, FaCss3Alt, FaRobot
} from 'react-icons/fa'
import {
  SiNextdotjs, SiTailwindcss, SiTypescript, SiDjango, SiSqlite, SiPostgresql,
  SiVercel, SiGooglecloud, SiFramer
} from 'react-icons/si'
...
const iconMap: { [key: string]: React.ReactNode } = {
  ...
  'Next.js 16': <SiNextdotjs className="text-black dark:text-white" />,
  ...
  'MySQL': <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" alt="MySQL" width={24} height={24} className="inline-block" />,
  ...
  'Claude AI': <TbSparkles className="text-[#D97706]" />,
  'Antigravity': <FaRobot className="text-[#8B5CF6]" />,
}
